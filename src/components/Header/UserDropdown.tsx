  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {/* <span className="block mr-1 font-medium text-theme-sm">Abdolkarim</span> */}
        {/* <svg
      ...
      <Dropdown
        ...
        className="absolute right-0 mt-[17px] flex w-[260px] flex-col rounded-2xl border
         border-gray-200 bg-white p-3 shadow-theme-lg  "
      >
        <div>
        ...
        <Link
          to="/signin"
          className="flex items-center gap-3 px-3 py-2 mt-3 font-medium text-gray-700 rounded-lg group text-theme-sm
           hover:bg-gray-100 hover:text-gray-700  "
        >
          <svg
            className="fill-gray-500 group-hover:fill-gray-700  "
