    ...
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-99999  lg:border-b ">
      <div className="flex items-center justify-between gap-4 w-full">
              ...
              <form>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="dark:bg-dark-900 h-11 w-full rounded-3xl border border-gray-200 bg-transparent py-2.5 pl-12 pr-14 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-800 dark:bg-gray-900 dark:bg-white/[0.03] dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800 xl:w-[430px]"
                  />
        ...
        <div
          ...
          } items-center justify-between   gap-4 px-5 py-4 lg:flex shadow-theme-md lg:justify-end lg:px-0 lg:shadow-none mr-2`}
        >
